...
<iframe src="{{ site.baseurl }}{% link activities/assign-applicants-to-projects.html %}" class="notebook"></iframe>

<p class="post-meta">
    <a href="{{ site.baseurl }}{% link activities/assign-applicants-to-projects.html %}">Open in a new page</a>,
    <a href="https://github.com/cmip6moap/cmip6moap.github.io/blob/main/activities/assign-applicants-to-projects.ipynb">Open source notebook</a>
</p>
